                ...
                children: <Widget>[
                  CircleAvatar(
                    ...
                    child: FlatButton(
                      ...
                      child: Icon(
                        _selected == 0 ? Icons.home : CupertinoIcons.home,
                        size: 35,
                        color: _selected == 0 ? Colors.black : Colors.black54,
                      ),
                    ),
                  ),
                  CircleAvatar(
                    ...
                    child: FlatButton(
                      ...
                      child: Icon(
                        _selected == 1 ? Icons.favorite : Icons.favorite_border,
                        size: 35,
                        color: _selected == 1 ? Colors.black : Colors.black54,
                      ),
                    ),
                  ),
                  CircleAvatar(
                    ...
                    child: FlatButton(
                      ...
                      child: Icon(
                        _selected == 2 ? Icons.info : Icons.info_outline,
                        size: 35,
                        color: _selected == 2 ? Colors.black : Colors.black54,
                      ),
                    ),
                  ),
                ],
